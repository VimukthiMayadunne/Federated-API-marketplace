...
app.use((req, res, next) => {
    ...
    res.append("Access-Control-Allow-Headers", "Origin, Accept,Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers , Authorization");
...
app.post('/getdetails', function(req, res) {
    ...
    Api.findOne({ '_id': apidetails.host }).exec((err, feed) => {
        if (err)
            console.log(err)
        else
            res.json(feed)
